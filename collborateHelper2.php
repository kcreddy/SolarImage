...
//  Purpose: Main Module for Collaboration
...
<script type="text/javascript">
    ...
    function annotation(annot_id) {
        ...
        this.DeleteLastAnnotationPoint = function () {
            ...
            if (this.pts_x.length > 1) {
                ...
                for (i = 0; i < this.pts_x.length; i++) {
                    ...
                    DrawAnnotPoint('myCanvas_fg', Math.round(this.pts_x[i] * im_ratio), Math.round(this.pts_y[i] * im_ratio), '#F433FF', 4);
                ...
                for (i = 0; i < this.pts_x.length - 1; i++) {
                    ...
                    if (connectPoints == "Yes"){
                        ...
                        DrawLineSegment('myCanvas_fg', Math.round(this.pts_x[i] * im_ratio), Math.round(this.pts_y[i] * im_ratio), Math.round(this.pts_x[i + 1] * im_ratio), Math.round(this.pts_y[i + 1] * im_ratio), '#00a9ff');
        ...
        this.ShortenPts = function () {
            ...
            annotations_x_NORM.pop(0, l - 1);

            annotations_y_NORM.pop(0, l - 1);



            annotations_x_PIXEL.pop(0, l - 1);

            annotations_y_PIXEL.pop(0, l - 1);
...
<script type="text/javascript">
    ...
    function webimage(id) {
            ...
            if ((idx != -1) && (this.page_in_use == 0)) {
                ...
                do {
                    ...
                    if (par_field == 'folder')
                        ...
                        // CARINA - Store image name in global var

                        Image_File_Name = par_value;

                        document.getElementById("imagename").innerHTML=Image_File_Name;
        ...
        this.GetImagePath = function () {
            return 'albums/' + this.dir_name + '/' + this.im_name;
        ...
        // CARINA - NOTE - Have not seen this code work as described below.
...
<script type="text/javascript">
    ...
    function Delete_user() {
        $.post("tools/dbInterface_insertuser.php", {IMAGE_FILE_NAME: Image_File_Name});
    ...
    function CollaborationAnnotationData() {


        $.post("tools/dbInterface_collaborate.php", {IMAGE_FILE_NAME: Image_File_Name}
        );
...

    {
       ...
       // var Img_Name = Image_File_Name;
        ...
        $.post("tools/dbInterface.php", {HOLE_ID: Hole_ID,IMAGE_FILE_NAME: Image_File_Name,
        ...
        // CARINA - CLEAR ALL ANNOTATION ARRAYS THAT HAD DATA STORED IN DATA BASE
...

    {
        ...
        $.get("tools/dbInterface.php", {IMAGE_FILE_NAME: Image_File_Name},

            function (data, status)

            {

                alert("<?php echo $lang['MESSAGE_ANNOTATION_DATA_RETRIEVED'] ?>" + "\r\n"
                ...
                // CARINA - data_obj_array[0] holds the number of annotations found
...
//alert("test" + length);
    ...
    function ShareCollaborationData()

    {
        ...
        $.post("tools/dbInterface_collaborate_submit.php", {IMAGE_FILE_NAME: Image_File_Name,
    ...
    function SubmitWithoutShareCollaborationData()

    {
        ...
        $.post("tools/dbInterface_collaborate_submit_private.php", {IMAGE_FILE_NAME: Image_File_Name,
    ...
    function SharePrivateAnnotationData()

    {
        ...
        $.get("tools/dbInterface_collaborate_submit_private.php", {IMAGE_FILE_NAME: Image_File_Name},
...
//alert("test" + length);
...

    {
        ...
        $.get("tools/dbInterface_collaborate_userdata.php", {IMAGE_FILE_NAME: Image_File_Name},
...

            {
                ...
                var table1 = document.getElementById("user_table");

                var header = table1.createTHead();
                var headr1 = header.insertRow(0);
                var headc1 = headr1.insertCell(0);
                headc1.innerHTML = "<b>Username</b>";
                var headc2 = headr1.insertCell(1);
                headc2.innerHTML = "<b>UserID</b>";
//                var headc3 = headr1.insertCell(2);
//                headc3.innerHTML = "<b>Share</b>";
//                var headc4 = headr1.insertCell(3);
//                headc4.innerHTML = "<b>Work Privately</b>";
                ...
                var length = data_obj_array[0];
                var cur_userid = data_obj_array[3];
                // Loop thru requested annotations and draw them in bright green
                ...
                for (i = 0; i < length; i++) {
                    ...
                    var c1 = row.insertCell(t);
                    c1.innerHTML = data_obj_array[1][i];
                    c1.style.color = data_obj_array[4][i];

                    var c2 = row.insertCell(t+1);
                    c2.innerHTML = data_obj_array[2][i];
                    c2.style.color = data_obj_array[4][i];


                    if (cur_userid == data_obj_array[2][i])
                    {
                        c1.style.color = data_obj_array[4][i];
...
//                        var c3 = row.insertCell(t+2);
//                        c1.appendChild = '<i class="material-icons">account_box</i>';

//                        var c4 = row.insertCell(t+3);
//                        c4.innerHTML = '<input id="Button" type="button" value="Submit without Share" onclick="javascript:SubmitWithoutShareCollaborationData();"/>';
...
//alert("test" + length);
    ...
    function RequestSharedAnnotationData()

    {
        ...
        $.get("tools/dbInterface_collaborate_submit.php", {IMAGE_FILE_NAME: Image_File_Name},
...

            {
                ...
                for (i = 0; i < length; i++) {
                    ...
                    DrawAnnotPoint('myCanvas_fg', Math.round((data_obj_array[1][i]) * Image_Ratio), Math.round((data_obj_array[2][i]) * Image_Ratio), data_obj_array[3][i], 4);
...
//alert("test" + length);
    ...
    function RequestAnnotationDataByDate()

    {
        ...
        $.get("tools/dbInterface_SearchUser.php", {IMAGE_FILE_NAME: Image_File_Name, Search_Date1: document.getElementById('Search_Date1').value, Search_Date2: document.getElementById('Search_Date2').value},
...
//alert("test" + length);
    ...
    // Carina - End RequestAnnotationData
        ...
        <header>
            ...
            <div class="row-1">
                ...
                <div class="buttons">
                    ...
                    <a class="button-2" style="position:relative; right:-70px" href="javascript:ShareCollaborationData();" title="<?php echo $lang['WORDING_ANNOTATION_SUBMIT']; ?>">SHARE ANNOTATIONS</a>

                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;

                    <a class="button-2" href="javascript:RequestAnnotationData();" title="<?php echo $lang['WORDING_ANNOTATION_REQUEST']; ?>">REQUEST ANNOTATIONS</a>

                    <a class="button-2" style="width:197px; text-align:center; position:relative; right:3px" href="services.php" title="<?php echo $lang['WORDING_ANNOTATION_QUIT']; ?>">QUIT - NO SAVE</a>

                    <n class="button-2" style="width:220px; height:3px; line-height:1px; text-align:center;" title="<?php echo $lang['WORDING_CONNECT']; ?>">CONNECT POINTS</n>
                ...
                <div class="padding">
                    ...
                    <div class="wrapper margin-bot">
                      ...
                      -->
                                ...
                                <h2 class="p0"><?php echo $lang['WORDING_ANNOTATE_PHOTO']; ?> <a style="font-size:20px;font-family:times" id="imagename"></a>

                                    <!--<form action="jaffa.php">Search based on User ID: <input type="text"  id="search" name="search"/><input type="submit" value="Submit"/></form>-->
                                </h2>

                            <!--    <form action="javascript:RequestAnnotationDataByUserName();" method="GET">
                                   User Name: <input type="text" name="Search_UserName" id = "Search_UserName" />
                                    <input type="submit" />
                                </form>

                                <form action="javascript:RequestAnnotationDataByDate();" method="GET">
                                    <input type="date" name="Search_Date1" id = "Search_Date1">
                                    <input type="date" name="Search_Date2" id = "Search_Date2">
                                    <input type="submit" />
                                </form>

-->
                                <input style="margin-left: %; padding-top: 7px; padding-bottom: 7px; font-size: 16px;" class="button-2" id="Button1" type="button" value="Submit and Share" onclick="javascript:ShareCollaborationData();"/>
                                &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                <input style="margin-left: %; padding-top: 7px; padding-bottom: 7px; font-size: 16px;" class="button-2" id="Button2" type="button" value="Submit Privately" onclick="javascript:SubmitWithoutShareCollaborationData();"/>
                                &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                <input style="margin-left: %; padding-top: 7px; padding-bottom: 7px; font-size: 16px;"⁠ class="button-2" id="Button3" type="button" value="Share Private annotations" onclick="javascript:SharePrivateAnnotationData();"/>

                                <p></p>
                                <table id = "user_table" name = "user_table" class = "TFtable">
                               ...
                               return false;"
                                         ...
                                         onmousemove="main_canvas.OnMouseMove(event);
