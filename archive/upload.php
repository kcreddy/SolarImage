...
<![endif]-->
   ...
   <div id="nav" >
        ...
        <a href="upload.php?lang=ca"><img src="translations/images/flag.ca.jpg" />
            ...
            <div class="wrapper p4">
                <div class="col-3">
                    <div class="indent">
                        ...
                        <form method="post" action="services.php" name="submit" enctype="multipart/form-data">
                            <input type="file" name="fileField"><br /><br />
                                
                                
                                <div class="buttons"><a class="button-2" href="services.php">Submit</a> <a                                    
