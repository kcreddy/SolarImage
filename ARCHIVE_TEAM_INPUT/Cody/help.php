              ...
              <div class="indent">
                ...
                <div class="news indent-bot2">
                  <time class="tdate-2"22.05.2011&nbsp;</time>  
                    ...
                    Carina utilizes the large userbase of the internet to study, analyze, and most importantly annotate images of the sun. The annotations of these images are recorded in a database where they can later be analyzed. Knowing what our sun is doing is vital to understanding solar weather to protect our satellites, power and communication systems, and other vital electronic systems.
                    <br />
                    <br />
                </div>
                <div class="news indent-bot2">
                  <time class="tdate-2"22.05.2011&nbsp;</time>  
                    ...
                    You start by creating a free account. From here you can log in access the suite of tools in the services tab. Here is where you can edit your profile information, upload a photo, annotate a photo, export annotation data, and access the #carina IRC chatroom on Mibbit. 
                    <br />
                    <br />
                </div>
                ...
                <div class="news indent-bot2">
                  <time class="tdate-2"22.05.2011&nbsp;</time>  
                        <p class="p1"><a href="#">Uploading a Photo</a></p>
                    Within the services tab clicking the Upload A Photo link will take you to the upload page where you can select the desired file and upload it. 
                    <br />
                    <br />
                </div>
                ...
                <div class="news indent-bot2">
                  <time class="tdate-2"22.05.2011&nbsp;</time>  
                    ...
                    Clicking on the Annotate A Photo link from the services tab will take you to the annotation tool. From here you can select an image to annotate. Start by placing your mouse cursor over the image. Your coordinates are seen in real time above the image. Click and place waypoints around the coronal holes in the image. You can delete your last waypoint or clear all points. When you're happy with the waypoints click Submit Annotations at the top to save your work. 
                    <br />
                    <br />                                    
                </div>
